...
const Mockup = () => {
    ...
    return (
        <section className="mt-8">
            <div className="hidden md:grid md:grid-cols-3 w-full h-full my-8 bg-black">
            ...
            >
                {
                    hoveredIndex === 0 && (
                        <div>
                            <div className="absolute top-[14rem] z-10 w-full animate-fade-in-right">
                                <h1 className="px-2 text-5xl uppercase text-primary text-center font-semibold ">Hard Rock</h1>
                                <span className="text-lg tracking-[0.5rem] font-light flex justify-center text-white uppercase">Cheese burguer</span>
                            </div>
                            <div className="absolute top-[24rem] flex justify-center items-center w-full z-10 animate-fade-in-right">
                                <p className="text-xs text-white font-light text-center max-w-xs">Queso provoleta con chimichurri, morcilla, morrón a la plancha, cebolla roja y ketchup ahumado</p>
                            </div>
                        </div>
                    )
                }
                <div className={`bg-mockup ${hoveredIndex === 0 && 'saturate-120 sepia-[0] opacity-30'} sepia-[.95] h-[720px]  w-full opacity-[0.5] bg-center object-cover bg-no-repeat duration-700 transition-all`} />
            </div>
